...
@section("main-content")
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 mt-5">
					...
					<div class="breadcrumb-title pe-3 user_profile cursor-pointer"><a href="{{BASE_URL}}/costs/items-indirect"><i class="bx bx-cookie pe-2"></i>indirect Cost Profile</a></div>
				 ...
				 <div class="dropdown ms-auto">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="">
                          <a class="dropdown-item" href="{{BASE_URL}}/costs/edit/{{$product->id}}"
                            >Edit Profile</a
                          >
                        </li>
									...
									<div class="card-body">
										...
										<div class="d-flex flex-column align-items-center text-center">
											<div class="mt-3">
												...
												<button class="btn btn-outline-warning">Inderect</button>
											</div>
										</div>
										<hr class="my-4" />
