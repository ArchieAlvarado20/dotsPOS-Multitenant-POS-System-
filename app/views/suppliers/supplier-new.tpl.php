							...
							<div class="card-body p-4">
								<form method="post" class="row g-3 needs-validation" novalidate>
									<div class="col-md-6">
										...
										<input name="supplier" type="text" class="form-control" id="bsValidation1" placeholder="Supplier" value="{{oldValue('supplier')}}" required>
									...
									<div class="col-md-6">
										...
										<input name="email" type="email" class="form-control" id="bsValidation2" placeholder="Email" value="{{oldValue('email')}}" required>
									...
									<div class="col-md-12">
										...
										<input name="contact_person" type="text" class="form-control" id="bsValidation4" placeholder="Contact Person" value="{{oldValue('contact_person')}}" required>
