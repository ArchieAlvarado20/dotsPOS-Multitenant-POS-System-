      ...
      <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
           ...
           @php $subpage = $URL[0] ?? '';@endphp
              <li  class="{{$subpage == 'sales' ? 'mm-active':''}}">
            <a href="javascript:;" class="has-arrow">
              <div class="parent-icon"><i class="bx bx-dollar"></i></div>
              <div class="menu-title">Sales</div>
            </a>
            <ul>
                @php $subpage = $URL[1] ?? '';@endphp
              <li class="{{$subpage == 'daily-sales' ? 'mm-active':''}}
              {{$subpage == 'cancel-sales' ? 'mm-active':''}}">
                <a href="{{BASE_URL}}/sales/daily-sales"
                  ><i class="bx bx-radio-circle"></i>Daily Sales</a
                >
              </li>
                @php $subpage = $URL[1] ?? '';@endphp
              <li class="{{$subpage == 'cancel-details' ? 'mm-active':''}}">
                <a href="{{BASE_URL}}/sales/cancelled-items"
                  ><i class="bx bx-radio-circle"></i>Cancelled Sales</a
                >
              </li>
              <li>
                <a href="{{BASE_URL}}/sales/top-selling"
                ...
                >
                 ...
                 @php $subpage = $URL[0] ?? '';@endphp
             <li class="{{$subpage == 'costs' ? 'mm-active':''}}">
            <a href="javascript:;" class="has-arrow">
            ...
            <ul>
              <li>
                <a href="{{BASE_URL}}/costs/daily-costs"
                  ><i class="bx bx-radio-circle"></i>Daily Costs</a
                >
              </li>
              <li class="{{$subpage == 'costs' ? 'mm-active':''}}">
                <a href="{{BASE_URL}}/costs/items-indirect"
                  ><i class="bx bx-radio-circle"></i>Items(Indirect) </a
                >
              </li>
              <li>
                <a href="{{BASE_URL}}/costs/billing"
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li>
                  <a
                    ...
                    href="{{BASE_URL}}/user-profile/{{$user->id}}"
