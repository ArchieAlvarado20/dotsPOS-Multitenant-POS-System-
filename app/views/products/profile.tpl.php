...
@section("main-content")
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 mt-5">
					...
					<div class="breadcrumb-title pe-3 user_profile cursor-pointer"><a href="{{BASE_URL}}/product"><i class="bx bx-cookie pe-2"></i>Product Profile</a></div>
				 ...
				 <div class="dropdown ms-auto">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="">
                          <a class="dropdown-item" href="{{BASE_URL}}/product/edit/{{$product->id}}"
                            >Edit Profile</a
                          >
                        </li>
                          <a class="dropdown-item" href="{{BASE_URL}}/product/delete/{{$product->id}}" onclick="return confirm('Are you sure you want to delete this Account?')"
                            >Delete Account</a
                          >
                        </li>
                        <!-- <li>
