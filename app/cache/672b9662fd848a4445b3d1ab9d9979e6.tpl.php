						...
						<div class="card mb-5">
							...
							<div class="card-body p-4">
								<form method="POST" enctype="multipart/form-data" id="myForm" class="row g-3 needs-validation" novalidate>
									...
									<div class="col-md-12">
										...
										<select id="bsValidation9" class="form-select" name="category">
											<option value="<?php echo esc($product->category);?>" selected hidden>
												<?php echo esc($product->category == 11 ? 'Small' : '');?>
												<?php echo esc($product->category == 22 ? 'Medium' : '');?>
												<?php echo esc($product->category == 33 ? 'Large' : '');?>
												<?php echo esc($product->category == 44 ? 'Addons' : '');?>
											</option>
								...
								<div class="col-md-12">
										...
										<div class="col-2">
											<center><img class="rounded me-lg-2 mx-auto" src="<?php echo esc(BASE_URL);?>/<?php echo esc($product->image);?>" alt=""  style="width:100%;max-width:100px;height:100%;max-height:100px;"></center>
										</div>
										</div>
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											...
											<button type="reset" class="btn btn-light px-4"><a href="<?php echo esc(BASE_URL);?>/product/profile/<?php echo esc($product->id);?>">Back</a></button>
										</div>
									</div>
								</form>
							</div>
