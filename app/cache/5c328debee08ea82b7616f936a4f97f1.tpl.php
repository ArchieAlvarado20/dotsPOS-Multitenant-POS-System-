...
<div class="alert alert-info bg-info mt-5 text-dark">
    <span><strong>Note:</strong>This form allows you to add a new indirect cost, such as non-storable items like utility bills, one-time-use materials, or employee salaries.</span><br />
					...
					<div class="col-xl-6 mx-auto">
						<div class="card mb-5">
							<div class="card-header px-4 py-3">
								<h5 class="mb-0">Add New Indirect Item</h5>
							</div>
							<div class="card-body p-4">
								<form method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
									<div class="col-md-6">
										<label for="bsValidation1" class="form-label">Indirect Item Code</label>
										<input name="pcode" type="text" class="form-control" id="bsValidation1" placeholder="Indirect Item Code" value="PC-<?php echo esc( $beta );?>" readonly>
									...
									<div class="col-md-6">
										<label for="bsValidation2" class="form-label">Indirect Item Name</label>
										<input name="p_name" type="text" class="form-control" id="bsValidation2" placeholder="Indirect Item Name" value="<?=oldValue('p_name')?>" required>
									...
									<div class="col-md-12">
										...
										<input type="text" name='category' value="Indirect" class="form-control" readonly>
									</div>
										
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="submit" class="btn btn-primary px-4">Submit</button>
											<a class="btn btn-light px-4" href="<?php echo esc(BASE_URL);?>/costs/items-indirect">Back</a>
										</div>
									</div>
								</form>
							</div>
