...
<?php ob_start(); $this->currentSection = "main-content";?>
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 mt-5">
					...
					<div class="breadcrumb-title pe-3 user_profile cursor-pointer"><a href="<?php echo esc(BASE_URL);?>/costs/items-indirect"><i class="bx bx-cookie pe-2"></i>indirect Cost Profile</a></div>
				 ...
				 <div class="dropdown ms-auto">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="">
                          <a class="dropdown-item" href="<?php echo esc(BASE_URL);?>/costs/edit/<?php echo esc($product->id);?>"
                            >Edit Profile</a
                          >
                        </li>
