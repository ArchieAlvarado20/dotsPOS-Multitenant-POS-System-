							...
							<div class="card-body p-4">
								<form method="POST" enctype="multipart/form-data" class="row g-3 needs-validation " id="myForm" novalidate >
									...
									<div class="col-md-6">
										...
										<input name="first_name" type="text" class="form-control" id="bsValidation1" placeholder="First Name" value="<?php echo esc(oldValue('first_name',$users->first_name));?>" required>
							 <?=showError($errors,'first_name')?> 
									...
									<div class="col-md-6">
										...
										<input name="last_name" type="text" class="form-control" id="bsValidation2" placeholder="Last Name" value="<?php echo esc(oldValue('last_name',$users->last_name));?>" required>
									...
									<div class="col-md-12">
										...
										<input name="phone" type="text" class="form-control" id="bsValidation3" placeholder="Phone" value="<?php echo esc(oldValue('phone',$users->phone));?>" required>
									...
									<div class="col-md-12">
										...
										<input name="email" type="email" class="form-control" id="bsValidation4" placeholder="Email" value="<?php echo esc(oldValue('email',$users->email));?>" required>
									...
									<div class="col-md-12">
										...
										<textarea name="address" class="form-control" id="bsValidation13" placeholder="Address ..." rows="3" required><?php echo esc(oldValue('address',$users->address));?></textarea>
										...
										<div class="col-2">
											<center><img class="rounded me-lg-2 mx-auto .file" src="../<?php echo esc($users->image);?>" alt=""  style="width:100%;max-width:100px;height:100%;max-height:100px;"></center>
										</div>
										</div>
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											...
											<button type="reset" class="btn btn-light px-4"><a href="<?php echo esc(BASE_URL);?>/user-profile/<?php echo esc($users->id);?>">Back</a></button>
										</div>
									</div>
								</form>
							</div>
