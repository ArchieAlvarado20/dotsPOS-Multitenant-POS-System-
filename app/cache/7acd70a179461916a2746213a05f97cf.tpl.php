      ...
      <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/daily-sales"
                  ><i class="bx bx-radio-circle"></i>Daily Sales</a
                >
              </li>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/cancelled-items"
                  ><i class="bx bx-radio-circle"></i>Cancelled Items</a
                >
              </li>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/top-selling"
            ...
            <ul>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/daily-costs"
                  ><i class="bx bx-radio-circle"></i>Daily Costs</a
                >
              </li>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/items-indirect"
                  ><i class="bx bx-radio-circle"></i>Items(Indirect) </a
                >
              </li>
              <li>
                <a href="<?php echo esc(BASE_URL);?>/billing"
      ...
      <header>
        <div class="topbar d-flex align-items-center">
          <nav class="navbar navbar-expand gap-3">
            ...
            <h3 class="text-info mt-1"><?php echo esc(APP_NAME);?></h3>
            ...
            <div class="user-box dropdown px-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li >
                  <a type="button"
                    class="dropdown-item d-flex align-items-center"
                    href="<?php echo esc(BASE_URL);?>/logout" onclick=""
