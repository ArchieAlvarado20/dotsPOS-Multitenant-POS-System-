...
<!--sidebar wrapper -->
      <div class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
          <div>
            <img
              src="assets/images/dotslogo.png"
              class="logo-icon"
              alt="logo icon"
            />
          </div>
        ...
        <ul class="metismenu" id="menu">
          <li>
            ...
            <ul>
              <li>
                <a href="index.html"
                  ><i class="bx bx-radio-circle"></i>eCommerce</a
                >
              </li>
              <li>
                <a href="index2.html"
                  ><i class="bx bx-radio-circle"></i>Analytics</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="ecommerce-products.html"
                  ><i class="bx bx-radio-circle"></i>Products</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="ecommerce-add-new-products.html"
                  ><i class="bx bx-radio-circle"></i>Add New Products</a
                >
              </li>
              <li>
            ...
            <ul>
              <li>
                <a href="component-alerts.html"
                  ><i class="bx bx-radio-circle"></i>Alerts</a
                >
              </li>
              <li>
                <a href="component-accordions.html"
                  ><i class="bx bx-radio-circle"></i>Accordions</a
                >
              </li>
              <li>
                <a href="component-badges.html"
                  ><i class="bx bx-radio-circle"></i>Badges</a
                >
              </li>
              <li>
                <a href="component-buttons.html"
                  ><i class="bx bx-radio-circle"></i>Buttons</a
                >
              </li>
              <li>
                <a href="component-cards.html"
                  ><i class="bx bx-radio-circle"></i>Cards</a
                >
              </li>
              <li>
                <a href="component-carousels.html"
                  ><i class="bx bx-radio-circle"></i>Carousels</a
                >
              </li>
              <li>
                <a href="component-list-groups.html"
                  ><i class="bx bx-radio-circle"></i>List Groups</a
                >
              </li>
              <li>
                <a href="component-media-object.html"
                  ><i class="bx bx-radio-circle"></i>Media Objects</a
                >
              </li>
              <li>
                <a href="component-modals.html"
                  ><i class="bx bx-radio-circle"></i>Modals</a
                >
              </li>
              <li>
                <a href="component-navs-tabs.html"
                  ><i class="bx bx-radio-circle"></i>Navs & Tabs</a
                >
              </li>
              <li>
                <a href="component-navbar.html"
                  ><i class="bx bx-radio-circle"></i>Navbar</a
                >
              </li>
              <li>
                <a href="component-paginations.html"
                  ><i class="bx bx-radio-circle"></i>Pagination</a
                >
              </li>
              <li>
                <a href="component-popovers-tooltips.html"
                  ><i class="bx bx-radio-circle"></i>Popovers & Tooltips</a
                >
              </li>
              <li>
                <a href="component-progress-bars.html"
                  ><i class="bx bx-radio-circle"></i>Progress</a
                >
              </li>
              <li>
                <a href="component-spinners.html"
                  ><i class="bx bx-radio-circle"></i>Spinners</a
                >
              </li>
              <li>
                <a href="component-notifications.html"
                  ><i class="bx bx-radio-circle"></i>Notifications</a
                >
              </li>
              <li>
                <a href="component-avtars-chips.html"
                  ><i class="bx bx-radio-circle"></i>Avatrs & Chips</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="content-grid-system.html"
                  ><i class="bx bx-radio-circle"></i>Grid System</a
                >
              </li>
              <li>
                <a href="content-typography.html"
                  ><i class="bx bx-radio-circle"></i>Typography</a
                >
              </li>
              <li>
                <a href="content-text-utilities.html"
                  ><i class="bx bx-radio-circle"></i>Text Utilities</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="icons-line-icons.html"
                  ><i class="bx bx-radio-circle"></i>Line Icons</a
                >
              </li>
              <li>
                <a href="icons-boxicons.html"
                  ><i class="bx bx-radio-circle"></i>Boxicons</a
                >
              </li>
              <li>
                <a href="icons-feather-icons.html"
                  ><i class="bx bx-radio-circle"></i>Feather Icons</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="form-elements.html"
                  ><i class="bx bx-radio-circle"></i>Form Elements</a
                >
              </li>
              <li>
                <a href="form-input-group.html"
                  ><i class="bx bx-radio-circle"></i>Input Groups</a
                >
              </li>
              <li>
                <a href="form-radios-and-checkboxes.html"
                  ><i class="bx bx-radio-circle"></i>Radios & Checkboxes</a
                >
              </li>
              <li>
                <a href="form-layouts.html"
                  ><i class="bx bx-radio-circle"></i>Forms Layouts</a
                >
              </li>
              <li>
                <a href="form-validations.html"
                  ><i class="bx bx-radio-circle"></i>Form Validation</a
                >
              </li>
              <li>
                <a href="form-wizard.html"
                  ><i class="bx bx-radio-circle"></i>Form Wizard</a
                >
              </li>
              <li>
                <a href="form-text-editor.html"
                  ><i class="bx bx-radio-circle"></i>Text Editor</a
                >
              </li>
              <li>
                <a href="form-file-upload.html"
                  ><i class="bx bx-radio-circle"></i>File Upload</a
                >
              </li>
              <li>
                <a href="form-date-time-pickes.html"
                  ><i class="bx bx-radio-circle"></i>Date Pickers</a
                >
              </li>
              <li>
                <a href="form-select2.html"
                  ><i class="bx bx-radio-circle"></i>Select2</a
                >
              </li>
              <li>
                <a href="form-repeater.html"
                  ><i class="bx bx-radio-circle"></i>Form Repeater</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="table-basic-table.html"
                  ><i class="bx bx-radio-circle"></i>Basic Table</a
                >
              </li>
              <li>
                <a href="table-datatable.html"
                  ><i class="bx bx-radio-circle"></i>Data Table</a
                >
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li>
                <a class="has-arrow" href="javascript:;"
                  ><i class="bx bx-radio-circle"></i>Basic</a
                >
                <ul>
                  <li>
                    <a href="auth-basic-signin.html" target="_blank"
                      ><i class="bx bx-radio-circle"></i>Sign In</a
                    >
                  </li>
                  <li>
                    <a href="auth-basic-signup.html" target="_blank"
                      ><i class="bx bx-radio-circle"></i>Sign Up</a
                    >
                  </li>
                  <li>
                    <a href="auth-basic-forgot-password.html" target="_blank"
                      ><i class="bx bx-radio-circle"></i>Forgot Password</a
                    >
                  </li>
                  <li>
                    <a href="auth-basic-reset-password.html" target="_blank"
                      ><i class="bx bx-radio-circle"></i>Reset Password</a
                    >
                  </li>
                </ul>
              </li>
              <li>
                <a class="has-arrow" href="javascript:;"
                  ><i class="bx bx-radio-circle"></i>Cover</a
                >
                <ul>
                  <li>
              ...
              <li>
                <a class="has-arrow" href="javascript:;"
                  ><i class="bx bx-radio-circle"></i>With Header Footer</a
                >
                <ul>
                  <li>
            ...
            <ul>
              <li>
                <a href="errors-404-error.html" target="_blank"
                  ><i class="bx bx-radio-circle"></i>404 Error</a
                >
              </li>
              <li>
                <a href="errors-500-error.html" target="_blank"
                  ><i class="bx bx-radio-circle"></i>500 Error</a
                >
              </li>
              <li>
                <a href="errors-coming-soon.html" target="_blank"
                  ><i class="bx bx-radio-circle"></i>Coming Soon</a
                >
              </li>
              <li>
                <a href="error-blank-page.html" target="_blank"
                  ><i class="bx bx-radio-circle"></i>Blank Page</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="charts-apex-chart.html"
                  ><i class="bx bx-radio-circle"></i>Apex</a
                >
              </li>
              <li>
                <a href="charts-chartjs.html"
                  ><i class="bx bx-radio-circle"></i>Chartjs</a
                >
              </li>
              <li>
                <a href="charts-highcharts.html"
                  ><i class="bx bx-radio-circle"></i>Highcharts</a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="map-google-maps.html"
                  ><i class="bx bx-radio-circle"></i>Google Maps</a
                >
              </li>
              <li>
                <a href="map-vector-maps.html"
                  ><i class="bx bx-radio-circle"></i>Vector Maps</a
                >
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li>
                <a class="has-arrow" href="javascript:;"
                  ><i class="bx bx-radio-circle"></i>Level One</a
                >
                <ul>
                  <li>
                    <a class="has-arrow" href="javascript:;"
                      ><i class="bx bx-radio-circle"></i>Level Two</a
                    >
                    <ul>
                      <li>
                        <a href="javascript:;"
                          ><i class="bx bx-radio-circle"></i>Level Three</a
                        >
                      </li>
                    </ul>
                  </li>
