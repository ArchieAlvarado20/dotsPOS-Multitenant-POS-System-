...
<?php ob_start(); $this->currentSection = "main-content";?>
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 mt-5">
					...
					<div class="breadcrumb-title pe-3 user_profile cursor-pointer"><a href="<?php echo esc(BASE_URL);?>/items-raw"><i class="bx bx-cookie pe-2"></i>Raw Stocks Profile</a></div>
				 ...
				 <div class="dropdown ms-auto">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="">
                          <a class="dropdown-item" href="<?php echo esc(BASE_URL);?>/items/edit/<?php echo esc($product->id);?>"
                            >Edit Profile</a
                          >
                        </li>
                          <a class="dropdown-item" href="<?php echo esc(BASE_URL);?>/items/delete/<?php echo esc($product->id);?>" onclick="return confirm('Are you sure you want to delete this Account?')"
                            >Delete Account</a
                          >
                        </li>
                        <!-- <li>
								...
								<div class="card profile">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<h6 class="mb-0"><?php echo esc($product->cost);?></h6>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
