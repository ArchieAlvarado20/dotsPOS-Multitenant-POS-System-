							...
							<div class="card-body p-4">
								<form method="POST" enctype="multipart/form-data" id="myForm" class="row g-3 needs-validation" novalidate>
									<div class="col-md-6">
										...
										<input name="pcode" type="text" class="form-control" id="bsValidation1" placeholder="Item Code" value="<?php echo esc($row->pcode);?>" readonly>
									...
									<div class="col-md-6">
										...
										<input name="p_name" type="text" class="form-control" id="bsValidation2" placeholder="Item Name" value="<?php echo esc(oldValue('p_name',$row->p_name));?>" required>
									...
									<input type="text" class="form-control" name="category" value="<?php echo esc($row->category == 0 ? 'Direct' : 'Indeirect');?>" readonly>
									</div>
								...
								<div class="col-md-12">
										...
										<div class="col-2">
											<center><img class="rounded me-lg-2 mx-auto" src="<?php echo esc(BASE_URL);?>/<?php echo esc($row->image);?>" alt=""  style="width:100%;max-width:100px;height:100%;max-height:100px;"></center>
										</div>
										</div>
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											...
											<button type="reset" class="btn btn-light px-4"><a href="<?php echo esc(BASE_URL);?>/items/profile/<?php echo esc($row->id);?>">Back</a></button>
										</div>
									</div>
								</form>
							</div>
